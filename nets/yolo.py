...
from .spp_net import simple_SPP
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False, improve=0):
        ...
        if self.simple_SPP == 1:
            self.sppcspc                = simple_SPP(transition_channels * 32, transition_channels * 16)
        else:
